  ...
  <div class="register">
    ...
    <div class="account">
      ...
      <div class="reg-box">
        ...
        <div class="ver-code">
          <button :disabled="textCode.isDisa"
           @click="sendCode(modelObj.phone)"
...
export default {
  ...
  methods: {
    ...
    // getCode() {
    //   //手机号不能为空
    //   if (this.modelObj.phone == "") {
    //     return;
    //   }

    //   let num = 5;
    //   this.textCode.text = num;
    //   this.textCode.isDisa = true;
    //   let time = setInterval(() => {
    //     num--;
    //     this.textCode.text = num;
    //     if (num <= 0) {
    //       this.textCode.text = "获取验证码";
    //       this.textCode.isDisa = false;
    //       clearInterval(time);
    //     }
    //   }, 1000);
    ...
    //   // this.axios({
    //   //   methods: "GET",
    //   //   url: "http://192.168.0.104:10020/getMessageCode",
    //   //   params: {
    //   //     phone: this.modelObj.phone
    //   //   }
    //   // })
    //   //   .then(result => {
